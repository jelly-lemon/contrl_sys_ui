...
class MainWindow():
    ...
    def init_menu_bar(self):
        ...
        :return: 无
        """
        self.ui.restart.triggered.connect(partial(self.start_one_key, self.ui.restart.text()))
        self.ui.lock.triggered.connect(partial(self.start_one_key, self.ui.lock.text()))
        self.ui.unlock1.triggered.connect(partial(self.start_one_key, self.ui.unlock1.text()))
